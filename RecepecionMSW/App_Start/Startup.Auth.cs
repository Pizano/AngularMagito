...
using RecepecionMSW.Providers;

namespace RecepecionMSW
{
    public partial class Startup
    {
        // variables login API usando Token
        public static OAuthAuthorizationServerOptions OAuthOptions { get; private set; }
        public static string PublicClientId { get; private set; }
        // Hasta aquí para el oAuth
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            OAuthOptions = new OAuthAuthorizationServerOptions
            {
                ...
                Provider = new ApplicationOAuthProvider(PublicClientId), // Clase del provider Providers/AApplicationOAuthProvider.cs
                AuthorizeEndpointPath = new PathString("/api/LogIn/ExternalLogin"),
                AuthenticationMode = Microsoft.Owin.Security.AuthenticationMode.Passive,
                AccessTokenExpireTimeSpan = TimeSpan.FromDays(30),//TimeSpan.FromHours(1.5),//TimeSpan.FromDays(1825),
